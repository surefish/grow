...
public class TNewsHospitalAction extends BaseAction implements Preparable{
	...
	public String listTNews(){
		...
		listTNews=tMessagesService.searchBycatalog("1", TNews.NORMAL_STATUS, currentPageNO, pageSize);
