...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <a href="<%=basePath%>modularSecurity/goAddTNews">
    ...
    <table class="tablelist">
        ...
        <tbody>
			...
			<tr>
				...
				<td ><s:property value="#News.fimagesurl"/></td>
				<td>
				<a href="<%=basePath%>modularSecurity/getTNewsID?tNewsID=<s:property value="#News.fuID" />"  class="tablelink">修改</a> 
				<a href="<%=basePath%>modularSecurity/deleteTNews?tNewsID=<s:property value="#News.fuID "/>" onclick="return confirm('你确定要删除')" class="tablelink">删除</a>
				</td>
			</tr>
			</s:iterator>   
        </tbody>
	...
	function gotoPage(){
		...
		if(!reg.test(maxPage)){
			...
			if(currentPageNO>maxPage){//共几页
				...
				window.location.href="<%=basePath%>modularSecurity/listTNews.action?currentPageNO="+currentPageNO;		
			}
		}
	}
</script> 
