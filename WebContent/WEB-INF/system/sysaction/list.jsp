  ...
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	<script type="text/javascript">
  		var url;
        function add(){
            window.location.href = '<%=basePath%>sysAction/goAddAction';
        }
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>sysAction/getactionID?actionID='+row.fuID;
         }
         }
             ...
             if(null==row){
               alert("请选择删除的行!");
                ...
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>sysAction/deleteAction?actionID='+row.fuID;
                    }
                });
               }
        ...
        function role(){
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>sysAction/listSysJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
    ...
    <table id="dg" class="easyui-datagrid" toolbar="#toolbar">
        <thead>
            <tr>
            	...
            	<th field="factionId"  width="200">操作编码</th>
                <th field="factionName" width="150">操作名称</th>
                <th field="furl" width="100">操作地址</th>        
                <th field="fdesc" width="220">操作描述</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
