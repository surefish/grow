  ...
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	<script type="text/javascript">
  		var url;
        function add(){
            window.location.href = '<%=basePath%>thospital/goAddThospital';
        }
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>thospital/getThospitalID?hospitalID='+row.fuID;
         }
         }
             ...
             if(null==row){
               alert("请选择删除的行!");
                ...
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>thospital/deleteThospital?hospitalID='+row.fuID;
                    }
                });
               }
        ...
        function role(){
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>thospital/thospitalJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
    ...
    <table id="dg" class="easyui-datagrid" toolbar="#toolbar">
        <thead>
            <tr>
            	...
            	<th field="fname"  width="200">医院名称</th>
                <th field="faccount" width="150">账号</th>
                <th field="fpw" width="100">密码</th>        
                <th field="fareacode" width="100">行政区域代码</th>
                  <th field="fintro" width="200">介绍</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
