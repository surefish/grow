...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <a href="<%=basePath%>totherplatformnews/goAddTNews">
    ...
    <table class="tablelist">
        ...
        <tbody>
			...
			<tr>
				...
				<td>
				<a href="<%=basePath%>totherplatformnews/getTNewsID?tNewsID=<s:property value="#News.fuID" />"  class="tablelink">修改</a> 
				<a href="<%=basePath%>totherplatformnews/deleteTNews?tNewsID=<s:property value="#News.fuID "/>" onclick="return confirm('你确定要删除')" class="tablelink">删除</a>
				</td>
			</tr>
			</s:iterator>   
        </tbody>
	...
	function gotoPage(){
		...
		if(!reg.test(maxPage)){
			...
			if(currentPageNO>maxPage){//共几页
				...
				window.location.href="<%=basePath%>totherplatformnews/listTNews.action?currentPageNO="+currentPageNO;		
			}
		}
	}
</script> 
