  ...
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	<script type="text/javascript">
  		var url;
        function add(){
            window.location.href = '<%=basePath%>doctor/goAddTDoctor';
        }
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>doctor/getTDoctorID?tDoctorID='+row.fuID;
         }
         }
             ...
             if(null==row){
               alert("请选择删除的行!");
                ...
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>doctor/deleteTDoctorID?tDoctorID='+row.fuID;
                    }
                });
               }
        ...
        function role(){
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>doctor/listTDoctorJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
    ...
    <table id="dg" class="easyui-datagrid" toolbar="#toolbar">
        <thead>
            <tr>
            	...
            	<th field="fname"  width="100">医生名称</th>
                <th field="fgender" width="100">性别</th>
                <th field="fphone" width="100">电话</th>        
                <th field="faccount" width="180">通行证</th>
                <th field="fpw" width="180">密码</th>
                <th field="tHfname" width="220">所在医院</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
