...
<html>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	<script type="text/javascript">
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>tstudenthealthy/getTStudentID?tstudentID='+row.fuID;
         }
         }
       	...
       	function doSearch(){
				...
				//alert(fuserName);
				window.location.href="<%=basePath%>tstudenthealthy/listTStudent.action?fname="
						+ fuserName;
               ...
               alert("请选择删除的行!");
                return;
                 ...
                 $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>tstudenthealthy/deleteTStudent?tstudentID='+row.fuID;
                    }
                });
               }
            }
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>tstudenthealthy/liststHealthJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
  ...
  <body>
    <table id="dg" class="easyui-datagrid" toolbar="#toolbar">
        <thead>
            <tr>
            	...
            	<th field="fno"  width="250">学号</th>
                <th field="fname" width="100">姓名</th>
                <th field="fleftv" width="120">视力-左眼</th>
                <th field="frightv" width="120">视力-右眼</th>
                <th field="fheight" width="100">身高</th>
                <th field="fweight" width="100">体重</th>
                 <th field="ftooth" width="100">牙齿</th>
    ...
    <div id="toolbar">
    	...
    	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="edit1()">查看</a>
