  ...
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	<script type="text/javascript">
        ...
        function add(){
            window.location.href = '<%=basePath%>tstudent/goAddTStudent';
        }
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>tstudent/getTStudentID?tstudentID='+row.fuID;
         }
         }
         function edit1(){
         var row = $('#dg').datagrid('getSelected');
         if(null==row){
          ...
          return;
           ...
           $.messager.confirm('提示','确定要转出吗?',function(r){
                    if (r){
                         window.location.href = '<%=basePath%>tstudent/rollout?tstudentID='+row.fuID;
                    }
                });
        ...
        function del(){
             ...
             if(null==row){
               alert("请选择删除的行!");
                ...
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>tstudent/deleteTStudent?tstudentID='+row.fuID;
                    }
                });
               }
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>tstudent/listTStudentJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
        ...
        <thead>
            <tr>
                ...
                <th field="fparentphone" width="150">家长手机</th>
                 <th field="fstatus" width="150">学生状态</th>
                  <th field="tclassName" width="100">所属班级</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
    	<div style="margin-top:5px;margin-bottom:5px;margin-left:25px">
	       ...
	       <span style="height:24px;font-weight:bold;color:#8E8E8E">|</span>
	        ...
	        <span style="height:24px;font-weight:bold;color:#8E8E8E">|</span>
	        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="edit1()">转出</a>
