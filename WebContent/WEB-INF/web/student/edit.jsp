...
<html>
		...
		function save(){
			...
			if($.trim($("#fname").val())==""){
					...
					return false;
				     ...
				     var myform=$("#myform");
			         myform.attr("action","<%=basePath%>tstudent/createOrEditTStudent");
				     myform.submit();
  ...
  <div style="width:auto;height:auto;" closed="true" buttons="#dlg-buttons">
	...
	<form id="myform" action="" method="post" ENCTYPE="multipart/form-data"> 
             ...
             <s:hidden name="tclass.fuID" id="dthFUID" value=""></s:hidden>
			<div class="fitem">
				<label>姓名：</label>
			...
			<div class="fitem">
				<label>出生日期：</label>
				<input class="easyui-textbox"  value="${student.fbirth}" name="student.fbirth" id="d11" type="text" onClick="WdatePicker()"/>
			</div>
			<div class="fitem">
				<label>家长姓名：</label>
			...
			<div class="fitem">
				<label>所属班级：</label>
				 <input  class="easyui-combobox" data-options="editable:false"  onchange="SetSubID();" value="请选择" id="cc" name="mallId" url="<%=basePath%>tstudent/goTclassJson" valueField="fuID" textField="fname"  panelHeight="auto"/>
			</div>
			<br />
