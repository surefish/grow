  ...
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	<script type="text/javascript">
  		var url;
        function add(){
            window.location.href = '<%=basePath%>tclass/goAddTClass';
        }
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>tclass/getTClassID?tclassID='+row.fuID;
         }
         }
             ...
             if(null==row){
               alert("请选择删除的行!");
                ...
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>tclass/deleteTClass?tclassID='+row.fuID;
                    }
                });
               }
        ...
        function role(){
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>tclass/tclassJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
    ...
    <table id="dg" class="easyui-datagrid" toolbar="#toolbar">
        <thead>
            <tr>
            	...
            	<th field="fname"  width="200">班级名称</th>
                <th field="fgrade" width="150">年级</th>
                <th field="forgcode" width="100">机构代码</th>        
                <th field="tSchoolName" width="220">所属学校</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
