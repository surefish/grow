  ...
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	//健康标准管理
  		var url;
        function add(){
            window.location.href = '<%=basePath%>thealthstd/goAddTHealthStd';
        }
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>thealthstd/getHealthID?healthID='+row.fuID;
         }
         }
             ...
             if(null==row){
               alert("请选择删除的行!");
                ...
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>thealthstd/deleteTHealthStd?healthID='+row.fuID;
                    }
                });
               }
        ...
        function role(){
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>thealthstd/tHealthStdJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
    ...
    <table id="dg" class="easyui-datagrid" toolbar="#toolbar">
        <thead>
            <tr>
            	...
            	<th field="ftype"  width="200">类型</th>
                <th field="fage" width="150">周岁</th>
                <th field="fnum" width="100">数值</th>        
                <th field="flownum" width="100">低数值</th>
                <th field="fhighnum" width="100">高数值</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
