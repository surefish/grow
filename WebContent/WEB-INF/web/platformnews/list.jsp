...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <a href="<%=basePath%>tplatformnews/goAddTNews">
    ...
    <table class="tablelist">
        ...
        <tbody>
			...
			<tr>
				...
				<td>
				<a href="<%=basePath%>tplatformnews/getTNewsID?tNewsID=<s:property value="#News.fuID" />"  class="tablelink">修改</a> 
				<a href="<%=basePath%>tplatformnews/deleteTNews?tNewsID=<s:property value="#News.fuID "/>" onclick="return confirm('你确定要删除')" class="tablelink">删除</a>
				</td>
			</tr>
			</s:iterator>   
        </tbody>
	...
	function gotoPage(){
		...
		if(!reg.test(maxPage)){
			...
			if(currentPageNO>maxPage){//共几页
				...
				window.location.href="<%=basePath%>tplatformnews/listTNews.action?currentPageNO="+currentPageNO;		
			}
		}
	}
</script> 
