  ...
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>js/easyui/jquery.easyui.min.js"></script>
   	...
   	<script type="text/javascript">
  		var url;
        function add(){
            window.location.href = '<%=basePath%>teacher/goAddTeacher';
        }
        ...
        function edit(){
         ...
         //alert("fuID:"+row.fuID);
          window.location.href = '<%=basePath%>teacher/getTeacherID?tTeacherID='+row.fuID;
         }
         }
             ...
             if(null==row){
               alert("请选择删除的行!");
                ...
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        window.location.href = '<%=basePath%>teacher/deleteTeacher?tTeacherID='+row.fuID;
                    }
                });
               }
        ...
        function role(){
	  	...
	  	$(function(){
	        ...
	        fit: true,//自动大小 
	        url:'<%=basePath%>teacher/listTeacherJson', 
	        //sortName: 'code', 
	        //sortOrder: 'desc',  
	        remoteSort:false,  
	        idField:'id', 
    ...
    <table id="dg" class="easyui-datagrid" toolbar="#toolbar">
        <thead>
            <tr>
                ...
                <th field="fgender" width="50">性别</th>
                <th field="furl" width="100">电话</th>        
                <th field="fphone" width="100">账号</th>
                <th field="fpw" width="100">密码</th>
                <th field="calassName" width="100">所属班级</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
